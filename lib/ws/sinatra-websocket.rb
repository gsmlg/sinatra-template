...
require File.expand_path('../sinatra-websocket/error', __FILE__)
require File.expand_path('../sinatra-websocket/ext/thin/connection', __FILE__)
require File.expand_path('../sinatra-websocket/ext/sinatra/request', __FILE__)
